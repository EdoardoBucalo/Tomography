...
class TomoModel(L.LightningModule):
    def __init__(self, input_size,learning_rate,k_0,k_1,k_2,k_5,k_6,k_7,k_8,s_1,s_2,s_3,s_6,s_7,s_8,s_9,output_channels,feature_map_size):
        super().__init__()
        ...
        self.conv_layers = nn.Sequential(
            nn.ConvTranspose2d(1, 32, k_0, s_1, padding=1, output_padding=0),  # Transpose Convolution
            nn.LeakyReLU(),
            nn.ConvTranspose2d(32, 64, k_1, s_2, padding=1, output_padding=0),
            nn.LeakyReLU(),
            nn.ConvTranspose2d(64, 128, k_2, s_3, padding=1, output_padding=0),
            nn.LeakyReLU(),
            nn.ConvTranspose2d(128, 64, k_5, s_6, padding=1,output_padding=0),
            nn.LeakyReLU(),
            nn.ConvTranspose2d(64, 32, k_6, s_7, padding=1, output_padding=0),
            nn.LeakyReLU(),
            nn.ConvTranspose2d(32, 16, k_7, s_8, padding=1,output_padding=0),
            nn.LeakyReLU(),
            nn.ConvTranspose2d(16, output_channels,k_8, s_9, padding=1, output_padding=0),  # Final Transpose Conv
