...
class TomoModel(L.LightningModule):
    def __init__(self, input_size, output_channels, learning_rate, feature_map_size, kernel_size,k0_size,k1_size,kf_size,k2_size, padding,stride,stride2,output_padding):
        super().__init__()
        ...
        self.conv_layers = nn.Sequential(
            ...
            nn.ReLU(),
            nn.ConvTranspose2d(32, 64, k0_size, stride2, padding, output_padding),
            nn.ReLU(),
            nn.ConvTranspose2d(64, 32, k1_size, stride, padding, output_padding),
            nn.ReLU(),
            nn.ConvTranspose2d(32, 16, k2_size, stride2, padding, output_padding),
            nn.ReLU(),
